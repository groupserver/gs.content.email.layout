...
setup(
    name='gs.content.email.layout',
    version=version,
    description="Page templates for HTML-formatted email notifications",
    ...
    keywords='page, zpt, page template, email, notification',
    author='Michael JasonSmith',
    author_email='mpj17@onlinegroups.net',
    url='https://github.com/groupserver/gs.content.email.layout/',
    license='ZPL 2.1',
